...
def run_trials(trials=5):
    ...
    for trial in range(0, trials):
        ...
        print("The point differential for " +
              game.players[0].get_name()+" was {0}.\n".format(scores[0]-scores[1]))
        cumulative_score = cumulative_score + scores[0] - scores[1]
    print("The overall point differential for " + game.players[0].get_name(
    )+" was {0}, or {1} points-per-hand.\n".format(cumulative_score, cumulative_score/(trials*2)))
